      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-theme-panel p-5 border border-theme-subtle flex flex-col">
          <div className="flex justify-between items-start mb-2">
            <span className="text-[10px] uppercase tracking-widest text-theme-primary opacity-60">
              Số từ ôn hôm nay
            </span>
          ...
          <div className="flex items-end gap-3 mt-1">
            ...
            {reviewedDiff !== 0 && (
              <span
                className={`flex items-center text-[11px] uppercase tracking-widest ${reviewedDiff > 0 ? "text-green-500" : "text-red-500"} mb-1`}
              >
                {reviewedDiff > 0 ? (
        ...
        <div className="bg-theme-panel p-5 border border-theme-subtle flex flex-col">
          ...
          <div className="flex items-end gap-3 mt-1">
            <span className="text-3xl font-serif text-theme-primary">
              {todayStats.reviewed > 0 ? 100 - correctRateToday : 0}%
            </span>
            {errorRateDiff !== 0 &&
              todayStats.reviewed > 0 &&
              yesterdayStats.reviewed > 0 && (
                <span
                  className={`flex items-center text-[11px] uppercase tracking-widest ${errorRateDiff < 0 ? "text-green-500" : "text-red-500"} mb-1`}
                >
                  {errorRateDiff < 0 ? (
                    <TrendingDown className="w-3 h-3 mr-1" />
                  ) : (
