...
// We need to add the dropdown somewhere. Let's add it directly below the dialogue item content, 
// when movingDialogueId === dialogue.id
const dropdownHTML = `
                              {movingDialogueId === dialogue.id && (
